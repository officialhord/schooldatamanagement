...
public class StudentDataEntry extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        webcamaccess = new javax.swing.JButton();
        ...
        webcamaccess.setText("Open webcam");
        webcamaccess.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                webcamaccessActionPerformed(evt);
            }
        });

        jButton8.setText("Snap");
    ...
    private void updateclass() {
        try {
            ...
            String newclass;
            String currentclass;
            String sql = "Select * from Student where RegistrationNumber  = 'SD/2018/-1846200479' ";
            ps = conn.prepareStatement(sql);
            rs = ps.executeQuery();

            if (rs.next()) {

                String regday = rs.getString("Date");
                currentclass = rs.getString("Year");
                monthbetween = Months.monthsBetween(DateTime.parse(regday), newday).getMonths();
                if (monthbetween == 12) {
                    yeartxt.setSelectedItem(currentclass);
                    int x = yeartxt.getSelectedIndex();
                    yeartxt.setSelectedIndex(x + 1);
                    newclass = yeartxt.getSelectedItem().toString();
                    String newsql = "Update Student Set Year = '" + newclass + "' where RegistrationNumber  = 'SD/2018/-1846200479' ";
            ...
            Logger.getLogger(StudentDataEntry.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
                rs.close();
                ps.close();
    ...
    public int GenerateId() {
        ...
        for (int j = 1000; j < 10000; j++) {
            randomId = (int) rand.nextLong() * -1;
        }
        return randomId;
    }

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        LocalDate regdate = new LocalDate();

        String regnumtxt = "SD/2018/" + GenerateId();
        String sql = "Insert into Student (Fullname, Registrationnumber, Year, Department, Passport, Date) Values (?,?,?,?,?,?)";
        try {
            ps = conn.prepareStatement(sql);
            ps.setString(1, fulnametxt.getText());
            ps.setString(3, yeartxt.getSelectedItem().toString());
            ps.setString(2, regnumtxt);
            ps.setString(6, regdate.toString());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            String sql = "Delete from Student where RegistrationNumber = '" + regnum.getText() + "' ";
            ps = conn.prepareStatement(sql);
            ps.execute();

            JOptionPane.showMessageDialog(null, "Student Data Delete done");
            updatetable();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
...
// TODO add your handling code here:
    ...
    private void webcamaccessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_webcamaccessActionPerformed
        ...
        webcam.start();
// TODO add your handling code here:
    }//GEN-LAST:event_webcamaccessActionPerformed
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentDataEntry.class
    ...
    private javax.swing.JButton webcamaccess;
